...
### Regra 4: Screenshots antes de análise visual
Para qualquer análise de design/UI, o fluxo OBRIGATÓRIO é:
1. Tentar aceder com browser subagent
2. Tirar screenshots reais  
3. **Verificar as screenshots** com view_file antes de reportar
4. Só depois descrever o que se vê

Nunca descrever design com base em conteúdo textual extraído (HTML/texto).
...
- [ ] Todas as afirmações visuais foram confirmadas por screenshot ou conteúdo directo?
